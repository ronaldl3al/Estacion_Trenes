...
def vista_ventas(page):
    ...
    sidebar = ft.Container(
        content=ft.Column(
            [
                ...
                ft.Row([ft.Text(f"Hola, {estacion.operador}", size=18, color=ft.colors.WHITE)]),
    ...
    dropdown_tren = ft.Dropdown(
        ...
        height=50,
        border_radius=7,
        options=[ft.dropdown.Option(tren.nombre) for tren in estacion.trenes]
    )
    ...
    fila_precios = ft.Row(
        [
            ft.Column(
                [
                    cantidad_adultos,
                    ft.Text(f"${estacion.precio:.2f}", size=15, weight=ft.FontWeight.BOLD)
                ],
                horizontal_alignment=ft.CrossAxisAlignment.CENTER
            ),
            ft.Column(
                [
                    cantidad_niños,
                    ft.Text(f"${(estacion.precio * 0.5):.2f}", size=15, weight=ft.FontWeight.BOLD)
                ],
                horizontal_alignment=ft.CrossAxisAlignment.CENTER
            ),
            ft.Column(
                [
                    ...
                    ft.Text(f"${(estacion.precio * 0.4):.2f}", size=15, weight=ft.FontWeight.BOLD)
                ],
                horizontal_alignment=ft.CrossAxisAlignment.CENTER
            ),
            ft.Column(
